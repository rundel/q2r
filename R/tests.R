QUARTO_WEB_SKIP = list(
  ts_rt = list(
    ...
    "docs/authoring/_brand-example.qmd"                                 = "q2#TBD-fenced-div-close-after-block (q2#206 fix introduced regression: closing `:::` of a fenced div containing a child block fails to parse; see notes/fenced_div_close_after_inner_block_issue.md)",
    "docs/authoring/_cross-references-listings.qmd"                     = "q2#TBD-fenced-div-close-after-block (q2#206 fix introduced regression: closing `:::` of a fenced div containing a child block fails to parse; see notes/fenced_div_close_after_inner_block_issue.md)",
    ...
    "docs/blog/posts/2023-12-05-asa-traveling-courses/index.qmd"        = "q2#156 (Q-2-39: grid tables are not supported)",
    "docs/blog/posts/2024-10-15-conf-workshops-materials/index.qmd"     = "q2#TBD-fenced-div-close-after-block (q2#206 fix introduced regression: closing `:::` of a fenced div containing a child block fails to parse; see notes/fenced_div_close_after_inner_block_issue.md)",
    "docs/blog/posts/2025-07-24-parameterized-reports-python/index.qmd" = "q2#TBD-fenced-div-close-after-block (q2#206 fix introduced regression: closing `:::` of a fenced div containing a child block fails to parse; see notes/fenced_div_close_after_inner_block_issue.md)",
    "docs/blog/posts/2025-11-24-conf-talk-videos/index.qmd"             = "q2#156 (Q-2-39: grid tables are not supported)",
    "docs/books/book-basics.qmd"                                        = "q2#TBD-fenced-div-close-after-block (q2#206 fix introduced regression: closing `:::` of a fenced div containing a child block fails to parse; see notes/fenced_div_close_after_inner_block_issue.md)",
    "docs/books/book-structure.qmd"                                     = "q2#TBD-fenced-div-close-after-block (q2#206 fix introduced regression: closing `:::` of a fenced div containing a child block fails to parse; see notes/fenced_div_close_after_inner_block_issue.md)",
    ...
    "docs/download/index.qmd"                                           = "q2#TBD-fenced-div-close-after-block (q2#206 fix introduced regression: closing `:::` of a fenced div containing a child block fails to parse; see notes/fenced_div_close_after_inner_block_issue.md)",
    "docs/download/prerelease.qmd"                                      = "q2#TBD-fenced-div-close-after-block (q2#206 fix introduced regression: closing `:::` of a fenced div containing a child block fails to parse; see notes/fenced_div_close_after_inner_block_issue.md)",
    "docs/extensions/distributing.qmd"                                  = "q2#TBD-fenced-div-close-after-block (q2#206 fix introduced regression: closing `:::` of a fenced div containing a child block fails to parse; see notes/fenced_div_close_after_inner_block_issue.md)",
    "docs/extensions/lua-api.qmd"                                       = "q2#TBD-fenced-div-close-after-block (q2#206 fix introduced regression: closing `:::` of a fenced div containing a child block fails to parse; see notes/fenced_div_close_after_inner_block_issue.md)",
    ...
    "docs/get-started/hello/positron.qmd"                               = "q2#TBD-fenced-div-close-after-block (q2#206 fix introduced regression: closing `:::` of a fenced div containing a child block fails to parse; see notes/fenced_div_close_after_inner_block_issue.md)",
    ...
    "docs/output-formats/typst.qmd"                                     = "q2#TBD-fenced-div-close-after-block (q2#206 fix introduced regression: closing `:::` of a fenced div containing a child block fails to parse; see notes/fenced_div_close_after_inner_block_issue.md)",
    ...
    "docs/websites/website-basics.qmd"                                  = "q2#TBD-fenced-div-close-after-block (q2#206 fix introduced regression: closing `:::` of a fenced div containing a child block fails to parse; see notes/fenced_div_close_after_inner_block_issue.md)",
    "docs/websites/website-drafts.qmd"                                  = "q2#TBD-fenced-div-close-after-block (q2#206 fix introduced regression: closing `:::` of a fenced div containing a child block fails to parse; see notes/fenced_div_close_after_inner_block_issue.md)",
    "docs/websites/website-listings.qmd"                                = "q2#156 (Q-2-39: grid tables are not supported)",
    "docs/websites/website-navigation.qmd"                              = "q2#TBD-quoted-underscore (Q-2-11 fires on `\"_blank\"` inside pipe-table cell; see notes/quoted_underscore_word_issue.md)",
  ...
  pd_rt = list(
    ...
    "docs/blog/posts/2024-10-15-conf-workshops-materials/index.qmd"     = "q2#TBD-fenced-div-close-after-block (q2#206 fix introduced regression: closing `:::` of a fenced div containing a child block fails to parse; see notes/fenced_div_close_after_inner_block_issue.md)",
    "docs/blog/posts/2025-07-24-parameterized-reports-python/index.qmd" = "q2#TBD-fenced-div-close-after-block (q2#206 fix introduced regression: closing `:::` of a fenced div containing a child block fails to parse; see notes/fenced_div_close_after_inner_block_issue.md)",
    "docs/blog/posts/2025-10-20-quarto-wizard-1-0-0/index.qmd"          = "q2#174 (loose list tightened on round-trip)",
    "docs/blog/posts/2025-11-24-conf-talk-videos/index.qmd"             = "q2#156 (Q-2-39: grid tables are not supported)",
    "docs/books/book-basics.qmd"                                        = "q2#TBD-fenced-div-close-after-block (q2#206 fix introduced regression: closing `:::` of a fenced div containing a child block fails to parse; see notes/fenced_div_close_after_inner_block_issue.md)",
    "docs/books/book-structure.qmd"                                     = "q2#TBD-fenced-div-close-after-block (q2#206 fix introduced regression: closing `:::` of a fenced div containing a child block fails to parse; see notes/fenced_div_close_after_inner_block_issue.md)",
    "docs/computations/caching.qmd"                                     = "q2#156 (Q-2-39: grid tables are not supported)",
...
gen_ts_rt_test = function(rel, skip_map = list()) {
  gen_test_block(rel, skip_map, c(
    ...
    "  ts = pampa_parse(text, ast = \"ts\", quiet = TRUE)",
    "  expect_no_error_diagnostics(ts)",
    "  if (has_error_diagnostics(ts)) return(invisible())",
    "  rendered = to_qmd(ts)",
    "  ts2 = pampa_parse(rendered, ast = \"ts\", quiet = TRUE)",
