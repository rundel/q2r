...
- Current pinned commit: `6e8795559783d7e0e6bc00b660e6eb39087d95a1`. Bumps are deliberate: update the `rev` **and** regenerate `Cargo.lock`. All four q2 deps (`pampa`, `tree-sitter-qmd`, `quarto-source-map`, `quarto-error-reporting`) must be bumped together.
